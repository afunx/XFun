...
public class DisplayParticleCreator {
    ...
    private static void createParticlesRight(@NonNull List<DisplayParticle> displayParticleList) {
        ...
        displayParticleList.add(
                new DisplayParticle.Builder()
                        .setStartX(DisplayMetrics.dp2px(1000.0f))
                        .setStartY(DisplayMetrics.dp2px(366.85f))
                        .setEndX(DisplayMetrics.dp2px(591.4f))
                        .setEndY(DisplayMetrics.dp2px(345.75f))
                        .setRadius(DisplayMetrics.dp2px(15.0f))
        ...
        displayParticleList.add(
                new DisplayParticle.Builder()
                        .setStartX(DisplayMetrics.dp2px(450.0f))
                        .setStartY(DisplayMetrics.dp2px(636.85f))
                        .setEndX(DisplayMetrics.dp2px(591.4f))
                        .setEndY(DisplayMetrics.dp2px(345.75f))
                        .setRadius(DisplayMetrics.dp2px(10.0f))
                        .setInterval(16 * 1000L)
                        .setStartTime("13:00")
                        .setEndTime("14:17")
                        .setEntranceTime("00:00")
        ...
        displayParticleList.add(
                new DisplayParticle.Builder()
                        .setStartX(DisplayMetrics.dp2px(1010.0f))
                        .setStartY(DisplayMetrics.dp2px(446.85f))
                        .setEndX(DisplayMetrics.dp2px(621.4f))
                        .setEndY(DisplayMetrics.dp2px(345.75f))
                        .setRadius(DisplayMetrics.dp2px(16.25f))
                        .setInterval(16 * 1000L)
                        .setStartTime("11:19")
                        .setEndTime("13:12")
                        .setEntranceTime("00:00")
        ...
        displayParticleList.add(
                new DisplayParticle.Builder()
                        ...
                        .setStartY(DisplayMetrics.dp2px(636.85f))
                        .setEndX(DisplayMetrics.dp2px(591.4f))
                        .setEndY(DisplayMetrics.dp2px(309.75f))
                        .setRadius(DisplayMetrics.dp2px(10.0f))
                        .setInterval(16 * 1000L)
                        .setStartTime("08:02")
                        .setEndTime("09:19")
    ...
    private static void createParticlesLeft(List<DisplayParticle> displayParticleList) {
        ...
        displayParticleList.add(
                new DisplayParticle.Builder()
                        .setStartX(DisplayMetrics.dp2px(-31.35f))
                        .setStartY(DisplayMetrics.dp2px(441.85f))
                        .setEndX(DisplayMetrics.dp2px(331.4f))
                        .setEndY(DisplayMetrics.dp2px(345.75f))
                        .setRadius(DisplayMetrics.dp2px(20.0f))
                        .setInterval(16 * 1000L)
                        .setStartTime("13:22")
                        .setEndTime("15:15")
                        .setEntranceTime("00:00")
        ...
        displayParticleList.add(
                new DisplayParticle.Builder()
                        .setStartX(DisplayMetrics.dp2px(558.65f))
                        .setStartY(DisplayMetrics.dp2px(671.85f))
                        .setEndX(DisplayMetrics.dp2px(331.4f))
                        .setEndY(DisplayMetrics.dp2px(345.75f))
                        .setRadius(DisplayMetrics.dp2px(20.0f))
                        .setInterval(16 * 1000L)
        ...
        displayParticleList.add(
                new DisplayParticle.Builder()
                        .setStartX(DisplayMetrics.dp2px(88.65f))
                        .setStartY(DisplayMetrics.dp2px(681.85f))
                        .setEndX(DisplayMetrics.dp2px(331.4f))
                        .setEndY(DisplayMetrics.dp2px(345.75f))
                        .setRadius(DisplayMetrics.dp2px(20.0f))
                        .setInterval(16 * 1000L)
